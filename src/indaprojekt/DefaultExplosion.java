...
public class DefaultExplosion extends Explosion
{
	...
	{
		return getAnimation().getCurrentFrame().getWidth();
	}
	...
	{
		return getAnimation().getCurrentFrame().getHeight();
	}
}
